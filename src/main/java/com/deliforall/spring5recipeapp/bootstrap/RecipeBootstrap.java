package com.deliforall.spring5recipeapp.bootstrap;

import com.deliforall.spring5recipeapp.domain.*;
import com.deliforall.spring5recipeapp.repositories.CategoryRepository;
import com.deliforall.spring5recipeapp.repositories.RecipeRepository;
import com.deliforall.spring5recipeapp.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<UnitOfMeasure> ounceUomOptional = this.unitOfMeasureRepository.findByDescription("Ounce");

        if(!ounceUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> pinchUomOptional = this.unitOfMeasureRepository.findByDescription("Pinch");

        if(!pinchUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> cupsUomOptional = this.unitOfMeasureRepository.findByDescription("Cup");
        ...
        guacRecipe.setDifficulty(Difficulity.EASY);
        ...
        tacosRecipe.setDifficulty(Difficulity.MODERATE);
